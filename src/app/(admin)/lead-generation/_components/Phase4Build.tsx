...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/app/(admin)/lead-generation/_components/ui/select";
import { PhaseShell } from "./PhaseShell";
import { IncompleteState } from "./IncompleteState";
import { Copy, ExternalLink, Sparkles, Loader2 } from "lucide-react";
import type { RankedLead } from "@/app/(admin)/lead-generation/_lib/types";
...
export function Phase4Build({
  ...
  useEffect(() => {
    ...
    async function fetchPrompt() {
      ...
      setTyped("");
      try {
        const res = await fetch("/lead-generation/api/generate-prompt", {
          method: "POST",
