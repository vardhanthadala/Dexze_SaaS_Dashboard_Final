...
export default function UserMetaCard() {
  ...
  const handleOpenModal = () => {
    setEditInfo(userInfo); // Reset edit state to current info when opening
    openModal();
  };
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="relative w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 group">
              ...
              <label
                ...
                className="absolute inset-0 flex items-center justify-center w-full h-full bg-black/50 opacity-0 cursor-pointer group-hover:opacity-100 transition-opacity"
              >
